  ...
  return (
    ...
    >
      {!!id && (
        ...
        >
          <ChevronIcon className="h5 w-5 shrick-0 text-muted-foreground/50" />
        </div>
      )}
      {documentIcon ? (
        ...
        <div className="ml-auto flex items-center gap-x-2">
          <DropdownMenu>
            <DropdownMenuTrigger asChild onClick={(e) => e.stopPropagation()}>
              <div
                role="button"
                className="opacity-0 group-hover:opacity-100 rounded-sm ml-auto hover:bg-neutral-300 dark:hover:bg-neutral-600 "
              >
